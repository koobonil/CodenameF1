...
; License page
!insertmacro MUI_PAGE_LICENSE "data\readme_kor.txt"
; Directory page
...
Section "MainSection" SEC01
  ...
  CreateShortCut "$SMPROGRAMS\월간구본일\F1 ${PRODUCT_VERSION}.lnk" "$INSTDIR\bin\f1.exe"
  CreateShortCut "$DESKTOP\월간구본일 F1 ${PRODUCT_VERSION}.lnk" "$INSTDIR\bin\f1.exe"
SectionEnd
